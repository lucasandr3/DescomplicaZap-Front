const API_BASE = 'https://raphasfit.com.br/api';
...
const openStore = document.querySelector('#customSwitchfechar');
const labelCheck = document.querySelector('.openst');
const icon       = document.querySelector('#icon-open');

statusOpenStore();

openStore.addEventListener('change', () => {
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        if (res.code == 0) {
          ...
          localStorage.setItem('open', status);
        ...
        if (status == 1) {
          toastr.success('Loja Fechada com sucesso.');
        } else {
...
let darkMode = document.querySelector('#switchDarkMode');
