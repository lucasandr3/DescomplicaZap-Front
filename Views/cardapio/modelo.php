        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                ...
                <?php elseif($config['view_products'] == '1'): ?>
                    ...
                    <div class="card" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;
                        filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));margin: 0 5px 10px;width: 33%;flex-grow: 1;min-height: 120px;box-sizing: border-box;justify-content: space-between;text-align: center;">
                        <?php if($prod['promo'] === 'yes'): ?>
                            <div class="ribbon">
                                <div class="wrap">
                                    <span class="ribbon6">Promoção</span>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="color: #777;font-size: 0.9rem;text-align:center;line-height: 1.5em;height: 6em;overflow: hidden;">
                                        <?=$prod['description']?></p>
                                    <p class="card-text" style="text-align:center;">
                                        ...
                                        <?php else: ?>
                                            <span class="span-price-dark" style="color: #d25850;font-weight: bold;"><?=($prod['price'] === '0.00')?'':real($prod['price'])?></span>
                                        <?php endif; ?>
                                    </p>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    ...
                    <div class="card mb-3" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));margin: 0px 0px 15px 0px;">
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="<?=$prod['image']?>" style="width:100%;border-radius: 10px;object-fit: contain;height:200px;"
                                    alt="<?=$prod['name_product']?>">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
...
<!--                                <button class="btn-address" onclick="deleteAddress()"><span class="material-icons">delete</span> Deletar</button>-->
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="retirada-cart" checked />
