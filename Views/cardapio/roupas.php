      ...
      location_on
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                ...
                <h2 id="<?=$item['name_category']?>" class="name-category" style="text-decoration:none;letter-spacing:2px;"><?=$item['name_category']?></h2>
                ...
                <div class="card-c shadow" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')">
                    ...
                    <div class="row-c">
                        ...
                        <div class="info-c">
                            <h5 class="card-title" style="font-weight:bold;color:#212121;"><?=$prod['name_product']?></h5>
                            <p class="card-text text-truncate" style="color: #555;font-size: 0.9rem;width: 210px;">
                                <?=$prod['description']?></p>
                ...
                <?php else: ?>
                    ...
                    <div class="card" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));margin: 0px 0px 15px 0px;">
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="<?=$prod['image']?>" style="width:100%;border-radius: 10px;object-fit: contain;height:120px;"
                                    alt="<?=$prod['name_product']?>">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title" style="font-weight:bold;color:#212121;text-align:center;"><?=$prod['name_product']?>
                                    </h5>
                                    <p class="card-text" style="color: #555;font-size: 0.9rem;text-align:center;">
                                        <?=$prod['description']?></p>
                                    <p class="card-text" style="text-align:center;">
                                        <?php if($prod['promo'] === 'yes'): ?>
                                            <span class="span-price-dark" style="color: #212529;opacity: 0.3;margin-right: 10px;"><s><?=real($prod['price'])?></s></span>
                                            <span class="span-price-dark" style="color: #212529;font-weight: bold;"><?=real($prod['promo_price'])?></span>
                                        <?php else: ?>
                                            <span class="span-price-dark" style="color: #212529;font-weight: bold;"><?=real($prod['price'])?></span>
                                        <?php endif; ?>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #212529;color: #fff;">
                                        <h5 class="modal-title text-capitalize" style="font-weight: bold;" id="exampleModalLabel"><?=$prod['name_product']?></h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close" style="background-color: #fff !important;opacity:1;"></button>
                                    </div>
                                    <div class="modal-body" style="padding:0;">
                                        <img src="<?=$prod['image']?>" class="img-modal-cart" style="object-fit:contain;" id="img-cart<?=$prod['id']?>">
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;color:#353535;"><span class="material-icons">shopping_bag</span></a>
    </main>
    </div>
    <!-- Modal cart -->
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #212529;color: #fff;">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background-color: #fff !important;opacity:1;"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="card-op-entrega shadow">
                        ...
                        <div class="card-address-session" style="border: 1px solid #212529;">
...
<!--                                <button class="btn-address" onclick="deleteAddress()"><span class="material-icons">delete</span> Deletar</button>-->
                        ...
                        <div class="btn-show-address">
                            <button class="btn btn-primary btn-add-c-t" style="width: 100%;background-color: #212529;border:#212529;border-radius:8px;" data-bs-target="#modal2" data-bs-toggle="modal" data-bs-dismiss="modalcart" id="btn-confirm-address">Informar Endereço</button>
                        </div>
                    </div>
...
<!--                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>-->
                    <button type="button" id="btn-close-modal-address" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                            style="display: flex;margin-right: 15px;"><span class="material-icons"
                                                                                                   style="margin-right:5px;">keyboard_backspace</span> Voltar</button>
                    <button type="button" class="btn btn-primary btn-add-c-t" style="width:100%;background-color: #212529;border: #212529" onclick="confirmAdrress()">Confirmar</button>
                </div>
            </div>
        </div>
    </div>
