...
<body>
      ...
      location_on
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                ...
                <?php if($config['view_products'] == '0'): ?>
                <div class="card-c shadow" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')"  id="step-three">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align:center;">
                                        <?php if($prod['promo'] === 'yes'): ?>
                                            <span class="span-price-dark" style="color: #41464b;opacity: 0.9;margin-right: 10px;font-size:14px;"><s><?=real($prod['price'])?></s></span>
    ...
    <!-- fim modal -->
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;justify-content: space-between;font-weight:bold;"><span>Minha Sacola<span id="total-bag-cart"></span></span><span class="material-icons">shopping_bag</span></a>
    </main>
    </div>
    <!-- Modal cart -->
